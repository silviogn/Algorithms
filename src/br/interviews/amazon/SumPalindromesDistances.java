...
public class SumPalindromesDistances {
	 ...
	 * This is use to not recalculate the distances when a new couple of palindromes 
	 * with the same distance is found.
	 */
	...
	/*
	 * This method return the distance to the next palindrome according
	 * the size of the number and if the size number is odd or pair.
	 * */
	...
	/*
	 * Return the next correct palindrome. Veriy changes in 
	 * left digits until the center.
	 * */
	...
	/*
	 * Return a new instance of the class. The visibility of the 
	 * constructor was modified to private.
	 * */
	...
	/**
	 * Return the sum of the distance between the palindromes between two numbers. 
	 */
